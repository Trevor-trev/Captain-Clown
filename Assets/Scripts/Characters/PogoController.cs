...
public class PogoController : MonoBehaviour
{
    ...
    void Update()
    {
        if (Time.timeScale != 0)
        {
            ...
            if (!ledgeClimb.ledgeHang && !ledgeClimb.ledgeClimb && !poleClimb.onPole && !doorwayCheck.walkingThroughDoor && (Input.GetKeyDown(keybinds.keys["Pogo Button"])))//If the character is not on a pole and the player presses the pogo button  
            ...
            {//-------------------------------------------------------------------If the character is not on the pogo stick
                ...
                xdirForTransitionToPogo = pmov.xdirection;
            ...
            if (onPogo)//---------------------------------------------------------If the character is on the pogo stick
            {
                ...
                if (Input.GetKey(keybinds.keys["Jump Button"]))
    ...
    private void FixedUpdate()
    {
        if (Time.timeScale != 0)
        {
            if (onPogo)//-------------------------------------------------------If the character is on the pogo stick
            {
                ...
                if (Input.GetKey(keybinds.keys["Jump Button"]))//----------------------------------If the player presses the jump button
